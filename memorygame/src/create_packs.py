...
def create_pack_layout():
    ...
    layout = [
        ...
        [sg.Text("Enter pack name:", font=custom_font, visible=False),  # Initially hidden
         sg.InputText(key="-PACK_NAME-", size=(40, 1), font=custom_font, visible=False),  # Initially hidden
         sg.Button("Confirm Pack Name", size=(15, 1), font=custom_font, visible=False)]  # Initially hidden
    ]
